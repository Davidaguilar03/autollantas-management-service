...
import com.autollantas.gestion.purchases.controller.FormularioCompraController;
...
public class PanelControlController {
    ...
    void actionNuevaVenta(ActionEvent event) {
        Object controller = MainLayoutController.getInstance().cargarVista("/com/autollantas/gestion/sales/views/FacturasVenta.fxml");
    ...
    void actionNuevaCompra(ActionEvent event) {
        MainLayoutController.getInstance().cargarVista("/com/autollantas/gestion/purchases/views/FormularioCompra.fxml");
    }

    @FXML
    void actionNuevoGasto(ActionEvent event) {
        Object controller = MainLayoutController.getInstance().cargarVista("/com/autollantas/gestion/treasury/views/GastosOperativos.fxml");
    ...
    void actionNuevoIngreso(ActionEvent event) {
        Object controller = MainLayoutController.getInstance().cargarVista("/com/autollantas/gestion/treasury/views/IngresoOcasional.fxml");
    ...
    void verAlertasStock(javafx.scene.input.MouseEvent event) {
        MainLayoutController.getInstance().cargarVista("/com/autollantas/gestion/inventory/views/AlertasStock.fxml");
    }
    ...
    void abrirDialogoReportes(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/autollantas/gestion/reporting/views/GeneracionReportes.fxml"));
