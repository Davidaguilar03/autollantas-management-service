...
public class SaleDetailsController {
    ...
    public void setSale(Sale sale) {
        ...
        lblFecha.setText(sale.getSaleDate() != null ? sale.getSaleDate().format(dateFormat) : "-");
        ...
        if (sale.getDueDate() != null) {
            lblVencimiento.setText(sale.getDueDate().format(dateFormat));
    ...
    private void setupTable() {
        ...
        colPrecio.setCellValueFactory(cell -> new SimpleStringProperty(currencyFormat.format(cell.getValue().getSalePrice())));
