...
public class FacturasCompraController {
    ...
    void btnEditarClick(ActionEvent event) {
        ...
        if (sel != null) {
            ...
            Object controllerObj = MainLayoutController.getInstance().cargarVista("/com/autollantas/gestion/purchases/views/FormularioCompra.fxml");
    ...
    private void abrirModalDetalles(Compra compra) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/autollantas/gestion/purchases/views/VerDetallesCompra.fxml"));
