...
public class PagosController {
    ...
    private void abrirFormularioPago(Compra compra) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/autollantas/gestion/purchases/views/FormularioPago.fxml"));
    ...
    private void abrirHistorialPagos(Compra compra) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/autollantas/gestion/purchases/views/HistorialPagos.fxml"));
            loader.setControllerFactory(springContext::getBean);
            Parent root = loader.load();
